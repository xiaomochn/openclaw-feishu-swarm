...
const FeishuSharedConfigShape = {
  ...
  // Bot Registry integration fields
  botRegistryUrl: z.string().optional(),
  botRegistryEnabled: z.boolean().optional(),
  botRegistryInboundBaseUrl: z.string().optional(),
  botRegistryMentionOpenIds: z.array(z.string()).optional(),
  botRegistryUserIdToOpenId: z.record(z.string(), z.string()).optional(),
};
